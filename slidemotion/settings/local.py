...
# Si estamos en Docker con PostgreSQL, usar la configuración de base.py
...
# Development-specific cache
# Si tenemos Redis disponible (Docker), usarlo. Si no, dummy cache
